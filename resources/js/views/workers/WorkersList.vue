        ...
        <div class="card-body">
            ...
            <template v-else>
                <template v-if="workers.length">
                    ...
                    >
                        <template #item.workers_count="{ item }">
                            <span class="badge alert-info" title="Broj aktivnih radnika">
                                {{ item.customer_count_active_workers }}
                                <span title="Ukupan broj radnika">({{ item.customer_count_all_workers }})</span>
                            </span>
                        </template>
